...
## 2024-07-20 - Avoid Math.sqrt and Math.pow in nested loops
...
**Action:** Compute squared distances using primitive multiplication (e.g., `dx * dx + dz * dz > gridSizeSq`) and cast operands to `long` if there's a risk of integer overflow.
