...
## 2024-07-26 - Replace Math.pow and Math.sqrt in hot loops
**Learning:** Using `Math.pow` and `Math.sqrt` for distance calculations inside performance-critical paths (like nested loops) adds unnecessary floating-point JNI overhead.
