...
public class ESP extends Module {
    ...
    private double getFadeAlpha(Entity entity) {
        ...
        double fadeDistValue = fadeDistance.get();
        double fadeDist = fadeDistValue * fadeDistValue; // ⚡ Bolt: Pre-calculate squared fade distance using primitive multiplication instead of Math.pow to avoid JNI overhead
        double alpha = 1;
