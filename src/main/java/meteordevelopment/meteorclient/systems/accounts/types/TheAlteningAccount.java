...
public class TheAlteningAccount extends Account<TheAlteningAccount> implements TokenAccount {
    ...
    public boolean fetchInfo() {
        try {
            AuthResponse res = Http.post("https://authserver.thealtening.com/authenticate").bodyJson(new AuthRequest("Minecraft", token, "Meteor", UUID.randomUUID().toString(), true)).sendJson(AuthResponse.class);
