...
public class TheAlteningAccount extends Account<TheAlteningAccount> implements TokenAccount {
    ...
    private AuthResponse getAuth() {
        AuthRequest req = new AuthRequest("Minecraft", name, System.getenv().getOrDefault("ALTENING_PASSWORD", "Meteor"), UUID.randomUUID().toString(), true);
